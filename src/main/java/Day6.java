...
public class Day6 {
    ...
    public static void main(String[] args) {
        ...
        int totalNumberOfQuestionsAnsweredWithYes6a = 0;
        int totalNumberOfQuestionsAnsweredWithYes6b = 0;

        for (String group : getGroups()) {

            Set<String> answeredQuestions6a = new TreeSet<>();
            Set<String> answeredQuestions6b = new TreeSet<>();

            String[] persons = group.split("\\n");

            for (int i = 0; i < persons.length; i++) {

                String[] answers = persons[i].split("");

                Collections.addAll(answeredQuestions6a, answers);

                if (i == 0) {
                    Collections.addAll(answeredQuestions6b, answers);
                } else {
                    answeredQuestions6b.removeIf(answeredQuestion -> !Arrays.asList(answers).contains(answeredQuestion));
                }
            }
            totalNumberOfQuestionsAnsweredWithYes6a += answeredQuestions6a.size();
            totalNumberOfQuestionsAnsweredWithYes6b += answeredQuestions6b.size();
        }
        System.out.println("6A: " + totalNumberOfQuestionsAnsweredWithYes6a);
        System.out.println("6B: " + totalNumberOfQuestionsAnsweredWithYes6b);
    }
    ...
    private static final String input = "zvxc\n" +
            "dv\n" +
            "vh\n" +
            "xv\n" +
            "jvem\n" +
